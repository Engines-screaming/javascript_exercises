...
-- code can be improved by moving country/city related fields to their own table and just have a foreign key pointing to a city/country id 
CREATE TABLE tickets
(
  id SERIAL PRIMARY KEY,
  first_name TEXT NOT NULL,
...
INSERT INTO tickets
  (first_name, last_name, seat, departure, arrival, airline, from_airport, to_airport)
VALUES
